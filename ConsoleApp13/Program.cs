...
class Program
{
    ...
    static void Main()
    {
        ...
        string str = "801-479-6347";
        
        var sArr = str.Split('7');
        if (sArr.Length > 2)
        {
        ...
        // debtors.Where(d =>
        // {
        //     var sArr = d.Email.Split('@');
        //     return sArr[1] == "rhyta.com" || sArr[1] == "dayrep.com";
        //          
        // }).Print();
        ...
        // debtors.FindAll(d =>
        // {
        //     return 2022 - d.BirthDay.Year > 26 && 2022 - d.BirthDay.Year < 36;
        // }).Print();
        ...
        // debtors.FindAll(d =>
        // {
        //     var sArr = d.Phone.Split('7');
        // 
        //     return d.FullName.Length > 18 && (sArr.Length > 2 || d.Phone.Contains('2'));
        // 
        // }).Print();
        ...
        // debtors.FindAll(d => { return d.BirthDay.Month > 10 || d.BirthDay.Month < 3;}).Print();
        ...
        // .Where(d =>
        // {
        //     return (debtors.Sum(d1 => d1.Debt)/ debtors.Count())< d.Debt;
        // })
        ...
        // debtors
        //  .Where((d => !d.Phone.Contains("8"))).Select(d => (d.FullName,2022 - d.BirthDay.Year , d.Debt)).Print();
        ...
        // debtors.Where(s => s.FullName.Distinct().Count() >= 3).OrderBy(s => s.FullName).Print();
        ...
        // debtors.OrderBy(s => s.Debt).Take(5).Print();

        // 15)Butun borcu olanlarin borcunu cemleyib umumi borcu cixartmaq +

        // Console.WriteLine(debtors.Sum(d1 => d1.Debt));

        // 16)2ci dunya muharibesin gormush borclularin siyahisi cixartmaq +

        // debtors.FindAll(d => d.BirthDay.Year > 1939 && d.BirthDay.Year < 1945).Select(d => d.FullName).Print();
        ...
        /// debtors.Where(d => ((d.BirthDay.Month - 1) * 500 > d.Debt)).Print();
